...
import com.example.gd10_d_10920.databinding.ActivityMainBinding
import com.example.gd10_d_10920.fragment.DataMahasiswaFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //keycode untuk nampung kata kuncinya
        binding.txtCari.setOnKeyListener(View.OnKeyListener{ _, keyCode, event->
            //jika keycodenya sama dengan yag dimasukkan dan actionya muncul
